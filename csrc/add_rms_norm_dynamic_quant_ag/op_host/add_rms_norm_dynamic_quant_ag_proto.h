 ...
 * \brief
 */
#ifndef OPS_NORM_ADD_RMS_NORM_DYNAMIC_QUANT_AG_PROTO_H_
#define OPS_NORM_ADD_RMS_NORM_DYNAMIC_QUANT_AG_PROTO_H_
...
REG_OP(AddRmsNormDynamicQuantAG)
    ...
    .ATTR(groupSize, Int, 0)
    .ATTR(epsilon, Float, 1e-6)
    .ATTR(output_mask, ListBool, {})
    .OP_END_FACTORY_REG(AddRmsNormDynamicQuantAG)
} // namespace ge
